        ...
        <div className="border border-[#FFD700]/20 rounded-lg p-4 bg-[#1a1a1a]">
          ...
          <div className="space-y-3">
            ...
            <div className="mt-3 p-3 bg-[#00C851]/10 border border-[#00C851]/30 rounded-lg space-y-2">
              ...
              <p className="text-sm text-[#00C851]">
                <strong>❌ Caso o serviço não seja viável:</strong> Se identificarmos qualquer limitação técnica que impeça a execução com qualidade adequada, <strong>o valor pago inicialmente (20%) será integralmente reembolsado, no prazo de até 2 dias úteis</strong>, pelo mesmo meio de pagamento.
              </p>
              <p className="text-sm text-[#00C851]">
